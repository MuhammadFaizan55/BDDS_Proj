...
def contact_us():
    ...
    st.markdown("<i class='far fa-envelope'></i> **Email:** [muhammadfaizan655210@gmail.com](mailto:muhammadfaizan655210@gmail.com)", unsafe_allow_html=True)
    st.markdown("<i class='fab fa-whatsapp-square'></i> **WhatsApp:** +923459169109", unsafe_allow_html=True)
